...
const MovedToAlquidPanel: React.FC<Props> = ({ feature }) => {
  ...
  return (
    <div className="flex h-full min-h-[400px] flex-col items-center justify-center gap-4 rounded-[var(--nfq-radius-card)] bg-[var(--nfq-bg-surface)] px-8 py-16 text-center">
