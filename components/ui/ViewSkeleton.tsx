...
export const CalculatorSkeleton: React.FC = () => (
  <div className="grid gap-4 lg:grid-cols-12">
    <div className="flex flex-col gap-3 lg:col-span-4">
      <Bone className="h-10 w-full rounded-[var(--nfq-radius-card)]" />
      <Bone className="h-10 w-full rounded-[var(--nfq-radius-card)]" />
      <Bone className="h-10 w-3/4 rounded-[var(--nfq-radius-card)]" />
      <Bone className="h-10 w-full rounded-[var(--nfq-radius-card)]" />
      <Bone className="h-10 w-5/6 rounded-[var(--nfq-radius-card)]" />
      <Bone className="h-10 w-full rounded-[var(--nfq-radius-card)]" />
    </div>
    <div className="flex flex-col gap-3 lg:col-span-8">
      <Bone className="h-48 w-full rounded-[var(--nfq-radius-card)]" />
      <div className="grid grid-cols-3 gap-3">
        <Bone className="h-20 rounded-[var(--nfq-radius-card)]" />
        <Bone className="h-20 rounded-[var(--nfq-radius-card)]" />
        <Bone className="h-20 rounded-[var(--nfq-radius-card)]" />
      </div>
      <Bone className="h-32 w-full rounded-[var(--nfq-radius-card)]" />
    </div>
  </div>
);
  ...
  <div className="flex flex-col gap-4">
    <div className="grid grid-cols-2 gap-3 md:grid-cols-4">
      {Array.from({ length: 4 }).map((_, i) => (
        <Bone key={i} className="h-24 rounded-[var(--nfq-radius-card)]" />
      ))}
    </div>
    <div className="grid gap-4 lg:grid-cols-2">
      <Bone className="h-64 rounded-[var(--nfq-radius-card)]" />
      <Bone className="h-64 rounded-[var(--nfq-radius-card)]" />
    </div>
  </div>
);
