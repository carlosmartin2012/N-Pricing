    ...
    <Drawer
      ...
      footer={
        <div className="flex justify-end gap-2">
          ...
          <button
            onClick={onSave}
            className="rounded bg-[var(--nfq-accent)] px-4 py-2 text-xs font-bold text-[color:var(--nfq-text-primary)] hover:bg-[var(--nfq-accent-hover)]"
          >
            Save Profile
          </button>
        </div>
    ...
    >
      {draft && (
        <div className="space-y-6">
          ...
          {validationError && (
            <div className="rounded border border-[color:var(--nfq-danger)]/25 bg-[var(--nfq-danger)]/10 px-3 py-2 text-xs text-[color:var(--nfq-danger)]">
              {validationError}
            </div>
          )}
