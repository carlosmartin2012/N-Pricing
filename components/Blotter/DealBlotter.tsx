...
const DealBlotter: React.FC = () => {
  ...
  return (
    ...
    {cursorsActive && cursors.length > 0 && (
      <div className="pointer-events-none absolute right-3 top-3 z-[70] rounded-full bg-[var(--nfq-success)]/90 px-2.5 py-0.5 text-[10px] font-mono text-[color:var(--nfq-text-primary)] shadow">
        {cursors.length} live
      </div>
    )}
