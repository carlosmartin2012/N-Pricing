...
import { Search, Plus, Save, Edit, Settings, Leaf, ShieldCheck, CheckCircle2, AlertTriangle, TrendingUp, XCircle, Database, Briefcase, UserPlus, FileSpreadsheet, Trash2, X, GitBranch, Users, Layers, Building2 } from 'lucide-react';
      ...
      <div className="flex flex-col h-full">
        ...
        {activeTab === 'GENERAL' ? (
            <>
                ...
                <div className="flex gap-2">
                    <button onClick={handleAddNewRule} className="flex items-center gap-1 px-3 py-1.5 bg-slate-800 text-slate-300 rounded border border-slate-700 text-xs hover:bg-slate-700">
