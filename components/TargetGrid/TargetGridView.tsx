  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="flex flex-wrap items-center gap-3">
        ...
        {/* View mode toggle */}
        <div className="flex rounded-[var(--nfq-radius-card)] bg-[var(--nfq-bg-elevated)] p-0.5">
          <button
            onClick={() => setViewMode('table')}
            className={`flex items-center gap-1.5 rounded-[var(--nfq-radius-card)] px-3 py-1.5 text-[11px] font-medium transition-colors ${
              viewMode === 'table'
          ...
          <button
            ...
            className={`flex items-center gap-1.5 rounded-[var(--nfq-radius-card)] px-3 py-1.5 text-[11px] font-medium transition-colors disabled:opacity-40 disabled:cursor-not-allowed ${
              viewMode === 'diff'
                ? 'bg-[var(--nfq-bg-highest)] text-[var(--nfq-accent)]'
                : 'text-[color:var(--nfq-text-muted)] hover:text-[color:var(--nfq-text-primary)]'
            }`}
        ...
        <button
          ...
          className="nfq-button flex items-center gap-1.5 px-4 py-2 text-[11px] font-medium text-[color:var(--nfq-text-muted)] transition-colors hover:text-[color:var(--nfq-text-primary)] disabled:opacity-40"
        >
          <Download size={12} />
          Export
        </button>
