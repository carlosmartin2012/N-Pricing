   ...
   return (
      <Panel title="Methodology Logic Engine" className="h-full bg-slate-850/50">
         <div className="p-4 flex flex-col h-full relative overflow-hidden">
            ...
            {!hasDeal ? (
               <div className="absolute inset-0 z-20 flex flex-col items-center justify-center text-center p-6 text-slate-600">
                  ...
                  <h3 className="text-sm font-bold text-slate-500 uppercase mb-1">No Scenario Active</h3>
                  <p className="text-xs text-slate-600 max-w-[200px]">Select a deal or configure parameters to visualize the pricing logic.</p>
               </div>
            ) : (
