...
const PricingReceipt: React.FC<Props> = ({ deal, setMatchedMethod, approvalMatrix }) => {
  ...
  return (
    <Panel title="Profitability & Pricing Construction" className="h-full border-l-4 border-l-cyan-500">
      <div className="flex flex-col h-full">
        
        {/* RAROC Scorecard */}
        <div className="p-4 bg-slate-900 border-b border-slate-700/50">
           <div className="flex justify-between items-start mb-3">
              ...
              <div className="text-right">
                 <h4 className="text-[10px] text-slate-500 uppercase tracking-widest font-bold">Client Rate</h4>
           ...
           <div className={`flex items-center gap-2 p-2 rounded border ${
              result.approvalLevel === 'Auto' ? 'bg-emerald-950/30 border-emerald-900 text-emerald-400' :
