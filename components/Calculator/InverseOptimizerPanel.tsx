  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="flex h-10 w-full items-center justify-center gap-2 rounded-lg bg-gradient-to-r from-[#F48B4A] via-[#E04870] to-[#9B59B6] px-4 text-xs font-semibold uppercase tracking-[0.16em] text-[color:var(--nfq-text-primary)] shadow-sm transition-opacity hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-50"
      >
        {isLoading ? (
          <>
            ...
            <>
              ...
              {onApplyMargin && (
                <button
                  type="button"
                  onClick={handleApply}
                  className="flex h-10 w-full items-center justify-center gap-2 rounded-lg border border-[color:var(--nfq-success)]/30 bg-[var(--nfq-success)]/10 px-4 text-xs font-semibold uppercase tracking-[0.16em] text-[color:var(--nfq-success)] transition-colors hover:bg-[var(--nfq-success)]/20"
                >
