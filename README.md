...
├── 5 Context Providers (Auth, Data, UI, Governance, MarketData)
...
npm run test           # Tests unitarios (Vitest — 192 tests)
...
├── components/          # Componentes React organizados por dominio (122 archivos)
...
├── contexts/            # 5 Context providers (Auth, Data, UI, Governance, MarketData)
...
├── supabase/            # SQL schemas, 9 migraciones, Edge Functions (Deno)
...
**Unit tests** (192 tests en 18 suites) cubriendo:
...
- [docs/pricing-methodology.md](./docs/pricing-methodology.md) — Metodologia FTP (16 gaps)
