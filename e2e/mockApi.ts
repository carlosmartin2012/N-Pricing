...
// Types + pure helpers + state factory live in ./mocks/. The dispatcher
// (registerApiMocks + fulfillDeals + fulfillConfig) stays here. See git
// log on 2026-05-14 for the extraction rationale.
import type { MockApiOptions, MockDealRow, MockState } from './mocks/types';
import {
